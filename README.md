...
| Pocket item tag prefix                  | Blank (don't add prefix)           | Specify a string to add prefix of tag, e.g. If you enter "pocket/" here, the pocket tag will be converted to "pocket/{tag in pocket}"                                                         |
